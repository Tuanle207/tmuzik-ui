...
export const playlistReducer = createReducer(intial, builder => {
  builder
    .addCase(playlistAction.setUserPlaylistsStorage,
      (state, action) => {
    ...
    .addCase(playlistAction.setPlaylistDetailStorage,
      (state, action) => {
    ...
    .addCase(playlistAction.setPlaylistItemStorage,
      (state, action) => {
    ...
    .addCase(playlistAction.removePlaylistStorage,
      (state, action) => {
    ...
    .addCase(playlistAction.removePlaylistItemStorage,
      (state, action) => {
        const detail = state.playlistDetails.find((x) => x.id === action.payload.id);
        if (detail) {
